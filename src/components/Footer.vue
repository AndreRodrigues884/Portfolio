<template>
  <footer class="bg-gray-100 py-8 mt-auto w-full">
    <div class="flex flex-col md:flex-row justify-between items-center text-gray-700 w-full px-6 max-w-full">
      <div class="flex flex-col space-y-4 md:space-y-2 md:flex-row md:space-x-6 md:items-center">
      ...
      <div class="flex space-x-6 mt-6 md:mt-0">
        <a href="https://www.linkedin.com/in/andr%C3%A9-rodrigues-2b526a285/" class="hover:text-blue-600"
          target="_blank" rel="noopener noreferrer">
          LinkedIn
        </a>
        <a href="https://github.com/AndreRodrigues884" class="hover:text-blue-600" target="_blank"
...
<style scoped>
/* Pode adicionar estilos extras aqui se precisar */
</style>